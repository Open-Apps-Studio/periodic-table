...
export const PROPERTY_FIELDS: PropertyField[] = [
  ...
  },
  {
    ...
    unit: 'J/(g·K)',
    accent: '#E85D04',
    value: (el) => el.specificHeat,
    display: (el) => numberText(el.specificHeat, 4),
  },
  {
    ...
    unit: 'kJ/mol',
    accent: '#DC2F02',
    value: (el) => el.heatOfVaporization,
    display: (el) => numberText(el.heatOfVaporization, 4),
  },
  {
    id: 'heatOfFusion',
    ...
    unit: 'kJ/mol',
    accent: '#F48C06',
    value: (el) => el.heatOfFusion,
    display: (el) => numberText(el.heatOfFusion, 4),
  },
  {
    id: 'thermalExpansion',
    ...
    unit: 'µm/(m·K)',
    accent: '#FFBA08',
    value: (el) => el.thermalExpansion,
    display: (el) => (el.thermalExpansion == null ? null : fmt(el.thermalExpansion * 1e6, 3)),
  },
  {
    id: 'speedOfSound',
